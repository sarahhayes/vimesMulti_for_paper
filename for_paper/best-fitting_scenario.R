...
## Might be good to have a plot of total cases, coloured by domestic and wildlife with singletons coloured lighter.
...
#ggsave("for_paper/cases_map_species_cluster.png")
col_by_status_map
...
#ggsave("for_paper/cluster_locations_three_or_more.png")

# Would also be good to have the clusters by time.
...
#### Alternatively, include all clusters of 2 or more and have singletons along the bottom
