### Extracting the cluster results from the third of best-fitting scenarios to incorporate in the paper supplement
### This is scenario 7, rayleigh distribution and assortativity 2.4
