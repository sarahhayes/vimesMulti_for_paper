...
#write.csv(prop_results, "for_paper/bootstrap_100_scenario_1_rayleigh.csv", row.names = F)
...
#write.csv(prop_results_gamma, "for_paper/bootstrap_100_scenario_1_gamma.csv", row.names = F)
