...
# Repeat for distance
dist_mean <- 0.87
params_spatial <- c(dist_mean, NA, dist_mean, NA,  dist_mean*5, NA)
...
#write.csv(prop_results, "for_paper/bootstrap_100_scenario_6_rayleigh.csv", row.names = F)
...
dist_mean <- 0.87
dist_sd <- 1.50
params_spatial <- c(dist_mean, dist_sd, dist_mean, dist_sd,  dist_mean*5, dist_sd*5)
...
#write.csv(prop_results_gamma, "for_paper/bootstrap_100_scenario_6_gamma.csv", row.names = F)
